...
if __name__ == '__main__':
    ...
    d = shelve.open('summary')
    for key in Teams.keys():
        d[key]={}
        d[key]['games']=Teams[key]
        if key in Teams_win.keys():
            d[key]['winning_rate']=Teams_win[key]/Teams[key]
        else:
            d[key]['winning_rate']=0
        d[key]['win_reasons']=win_Reasons[key]
        d[key]['lose_reasons']=lose_Reasons[key]    
    d.close()
